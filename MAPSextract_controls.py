...
ht = ht.group_by('context', 'ref', 'alt', 'methylation_level', 'protein_coding', 'worst_csq').aggregate(variant_count=hl.agg.count_where(ht.freq[214].AC > 0), singleton_count=hl.agg.count_where(ht.freq[214].AC == 1))
...
syn_ps_ht.export('gs://20211021-maps/syn_ps_controls.tsv')