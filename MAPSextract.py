...
ht = ht.group_by('context', 'ref', 'alt', 'methylation_level', 'protein_coding', 'worst_csq').aggregate(variant_count=hl.agg.count(), singleton_count=hl.agg.count_where(ht.freq[0].AC == 1))
